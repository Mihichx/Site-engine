...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 20 2026 г., 18:16
...
(28, 8, 'Статуэтка «Пушистый страж»', 1500, 'img/statuette1.jpg', '', '', '', '', '', '', '', ''),
(29, 8, 'Статуэтка «Кроличий секрет»', 2120, 'img/statuette2.jpg', '', '', '', '', '', '', '', ''),
(30, 8, 'Статуэтка «Нежность небес»', 2940, 'img/statuette3.jpg', '', '', '', '', '', '', '', ''),
(31, 9, 'Шкатулка «Розовое вдохновение»', 2310, 'img/box1.jpg', '', '', '', '', '', '', '', ''),
(32, 9, 'Шкатулка «Сердце в золоте»', 3020, 'img/box2.jpg', '', '', '', '', '', '', '', ''),
(33, 9, 'Шкатулка «Голубая роза»', 2970, 'img/box3.jpg', '', '', '', '', '', '', '', ''),
(34, 10, 'Поднос «Элегантный порядок»', 3590, 'img/tray1.jpg', '', '', '', '', '', '', '', ''),
(35, 10, 'Поднос «Нежная симфония»', 4100, 'img/tray2.jpg', '', '', '', '', '', '', '', ''),
(36, 10, 'Поднос «Золотая симметрия»', 3810, 'img/tray3.jpg', '', '', '', '', '', '', '', ''),
(37, 11, 'Тарелка «Нежная мелодия»', 1990, 'img/plate1.jpg', '', '', '', '', '', '', '', ''),
(38, 11, 'Тарелка «Цветочный венок»', 2340, 'img/plate2.jpg', '', '', '', '', '', '', '', ''),
(39, 11, 'Тарелка «Голубая мечта»', 2160, 'img/plate3.jpg', '', '', '', '', '', '', '', ''),
(40, 12, 'Конфетница «Золотой сад»', 20170, 'img/bonbonniere1.jpg', '', '', '', '', '', '', '', ''),
(41, 12, 'Конфетница «Триумф золота»', 18200, 'img/bonbonniere2.jpg', '', '', '', '', '', '', '', ''),
(42, 12, 'Конфетница «Венок природы»', 17140, 'img/bonbonniere3.jpg', '', '', '', '', '', '', '', '');
