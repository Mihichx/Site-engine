...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 22 2026 г., 17:28
...
(1, 1, 'Ваза из прозрачного стекла 15 см', 810, 'img/vase1.jpg', 'Элегантная ваза из прозрачного стекла для цветов.', 'Идеально подходит для небольших букетов. Легко моется, устойчива к перепадам температур.', 'стекло', 'прозрачный', '15', '7', '7', '200'),
(2, 1, 'Ваза из прозрачного стекла 11 см', 1180, 'img/vase2.jpg', 'Миниатюрная ваза из прозрачного стекла.', 'Подходит для одного-двух цветов. Компактная, не занимает много места.', 'стекло', 'прозрачный', '11', '5', '5', '0.15'),
(3, 1, 'Ваза из прозрачного стекла 24 см', 3800, 'img/vase3.jpg', 'Большая ваза из прозрачного стекла.', 'Идеально для крупных композиций. Устойчивое основание предотвращает опрокидывание.', 'стекло', 'прозрачный', '24', '12', '12', '0.8'),
(4, 1, 'Ваза из керамики 22 см', 1240, 'img/vase4.jpg', 'Стильная керамическая ваза для цветов.', 'Матовая поверхность, устойчива к царапинам. Отлично подойдёт для сухоцветов или живых цветов. Добавит уюта в гостиную или спальню.', 'керамика', 'бежевый', '22', '10', '10', '0.7'),
(5, 1, 'Ваза из керамики 19 см', 1000, 'img/vase5.jpg', 'Керамическая ваза среднего размера для декора.', 'Глянцевая поверхность, легко очищается. Компактный размер позволяет разместить вазу на тумбочке или комоде. Доступная альтернатива стеклянным вазам.', 'керамика', 'белый с го', '19', '9', '9', '0.65'),
(6, 1, 'Ваза из керамики 15 см', 2400, 'img/vase6.jpg', 'Элегантная керамическая ваза маленького размера.', 'Ручная роспись, уникальный дизайн. Подходит для одного цветка или декоративной композиции. Станет изюминкой вашего интерьера.', 'керамика', 'кремовый с', '15', '7', '7', '0.5'),
(7, 1, 'Ваза из керамики 23 см', 750, 'img/vase7.jpg', 'Практичная керамическая ваза для домашних цветов.', 'Простая форма, нейтральный цвет. Отлично подойдёт для кактусов или суккулентов. Лёгкая и прочная.', 'керамика', 'серый', '23', '11', '11', '0.75'),
(8, 1, 'Ваза из керамики 30 см', 7500, 'img/vase8.jpg', 'Роскошная керамическая ваза для композиций.', 'Ручная работа, сложный орнамент. Идеально для больших букетов. Премиальный сегмент — для ценителей искусства.', 'керамика', 'терракотов', '30', '15', '15', '3'),
(9, 1, 'Ваза из керамики 26 см', 1200, 'img/vase9.jpg', 'Керамическая ваза с рельефным узором.', 'Среднеразмерная ваза для домашних цветов. Рельефный орнамент придаёт изделию особый шарм. Отлично впишется в классический интерьер.', 'керамика', 'кремовый', '26', '12', '12', '0.9'),
